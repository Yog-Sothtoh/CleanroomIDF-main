...
public class ModelWitherzilla extends ModelBase {
    ...
    public ModelWitherzilla() {
        ...
        this.heads[1].func_78789_a(-3.0F, -3.0F, -3.0F, 6, 6, 6);
        this.heads[2] = new ModelRenderer(this, 32, 0);
        this.heads[2].func_78789_a(-3.0F, -3.0F, -3.0F, 6, 6, 6);
    }
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
        ...
        float f6 = MathHelper.func_76134_b(p_78087_3_ * 0.025F);
        this.spine[1].field_78795_f = (0.025F + 0.05F * f6) * (float)Math.PI;
        ...
        if (entitytitan.getInvulTime() < 1000) {
            this.heads[0].func_78793_a(0.0F, 0.0F, 0.0F);
            this.heads[1].func_78793_a(-10.0F, 4.0F, 0.0F);
            this.heads[2].func_78793_a(10.0F, 4.0F, 0.0F);
            this.spine[0].func_78793_a(0.0F, 0.0F, 0.0F);
            this.spine[1].func_78793_a(-2.0F, 6.9F, -0.5F);
        } else {
            this.heads[0].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
            this.heads[1].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
            this.heads[2].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
            this.spine[0].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
            this.spine[1].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
            this.spine[2].func_78793_a((float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F), (float)(entitytitan.func_70681_au().nextGaussian() * (double)2.0F));
        }
