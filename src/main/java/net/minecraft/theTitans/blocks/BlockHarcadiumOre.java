...
public class BlockHarcadiumOre extends BlockOre {
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
        return MathHelper.func_76136_a(this.rand, 15, 50);
    }
    ...
    public void func_149734_b(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
        ...
        if (p_149734_5_.nextInt(200) == 0) {
            p_149734_1_.func_72980_b((double)((float)p_149734_2_ + 0.5F), (double)((float)p_149734_3_ + 0.5F), (double)((float)p_149734_4_ + 0.5F), "thetitans:harcadiumBlockHum", 1.0F, 1.0F, false);
        }
