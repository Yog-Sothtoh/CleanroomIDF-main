...
public class ItemAdminiumAxe extends ItemAxe {
    public ItemAdminiumAxe(String unlocalizedName, Item.ToolMaterial material) {
        super(material);
        this.func_111206_d("thetitans:adminium_axe");
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (target != null && (target.field_70131_O >= 6.0F || target instanceof EntityTitan || !target.field_70122_E)) {
            target.func_70097_a(DamageSourceExtra.causeAntiTitanDamage(attacker), 4.0E9F);
            target.func_85030_a("thetitans:titanpunch", 100.0F, 0.5F);
        }
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack) {
        MovingObjectPosition raycast = raytraceFromEntity(entityLiving.field_70170_p, entityLiving, true, (double)10.0F);
        if (!entityLiving.field_70170_p.field_72995_K && raycast != null && entityLiving.func_70011_f((double)raycast.field_72311_b, (double)raycast.field_72312_c, (double)raycast.field_72309_d) <= (double)6.0F) {
