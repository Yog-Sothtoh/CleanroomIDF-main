...
public class ItemVoidSword extends ItemSword {
    public ItemVoidSword(String unlocalizedName, Item.ToolMaterial material) {
        super(material);
        this.func_111206_d("thetitans:void_sword");
                ...
                if (list1 != null && !list1.isEmpty()) {
                    for(int i11 = 0; i11 < list1.size(); ++i11) {
                        ...
                        if (target != p_77615_3_ && (target instanceof EntityLivingBase || target instanceof EntityTitanPart)) {
                            target.func_70097_a(DamageSourceExtra.causeAntiTitanDamage(p_77615_3_), 3000.0F * f);
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (target != null) {
            ...
            if (target.field_70131_O >= 6.0F || target instanceof EntityTitan || !target.field_70122_E) {
                target.func_70097_a(DamageSourceExtra.causeAntiTitanDamage(attacker), 1500.0F);
                target.func_85030_a("thetitans:titanpunch", 10.0F, 1.0F);
            }
        }
