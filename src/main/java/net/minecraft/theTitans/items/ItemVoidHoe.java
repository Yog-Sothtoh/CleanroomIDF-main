...
public class ItemVoidHoe extends ItemSword {
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (target != null && target instanceof EntityLivingBase) {
            if (target instanceof EntityLiving && target.field_70170_p.field_72995_K) {
                ((EntityLiving)target).func_70656_aK();
            }

            if (!(target.field_70131_O >= 6.0F) && !(target instanceof EntityTitan) && target.field_70122_E) {
                if (!(target instanceof EntityPlayer) && !(target instanceof EntityGolem)) {
                    attacker.field_70170_p.func_72900_e(target);
                    target.func_85030_a("random.fizz", 1.0F, 0.5F);
                    attacker.func_70690_d(new PotionEffect(Potion.field_76443_y.field_76415_H, 1, 3, false));
                    attacker.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a((double)(attacker.func_110138_aP() + target.func_110138_aP()));
                    attacker.func_70691_i(target.func_110138_aP());
                    if (target instanceof EntityMob && target.func_110140_aT().func_111151_a(SharedMonsterAttributes.field_111264_e) != null) {
                        attacker.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)((float)attacker.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111125_b() + (float)target.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111125_b()));
                    }
                }
            } else {
                target.func_70097_a(DamageSourceExtra.causeAntiTitanDamage(attacker), 5000.0F);
