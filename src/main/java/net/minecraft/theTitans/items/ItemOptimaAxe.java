...
public class ItemOptimaAxe extends ItemSword {
    public static Item.ToolMaterial enumToolMaterialOptima = EnumHelper.addToolMaterial("Optima", Integer.MAX_VALUE, 2, 9999999.0F, 999996.0F, 0);
            ...
            for(int i1 = 0; i1 < list1.size(); ++i1) {
                ...
                if (entity instanceof IMob || entity instanceof EntityPlayer) {
                    if (player.func_70685_l(entity)) {
                        player.func_145747_a(new ChatComponentText("Optima Axe: §l§oThe " + ((EntityLivingBase)entity).func_70005_c_() + " is " + player.func_70032_d(entity) + "§l§o blocks away from you."));
                    } else {
                        player.func_145747_a(new ChatComponentText("Optima Axe: §l§oAn unseen mob is located out of your §l§osight " + player.func_70032_d(entity) + " blocks away from you."));
                        player.func_145747_a(new ChatComponentText("Optima Axe: §l§oThe mob's health: " + ((EntityLivingBase)entity).func_110143_aJ() + "/" + ((EntityLivingBase)entity).func_110138_aP()));
                        player.func_145747_a(new ChatComponentText("Optima Axe: §l§oThe mob's name: " + ((EntityLivingBase)entity).func_70005_c_()));
            ...
            for(int i2 = -8; i2 <= 8; ++i2) {
                for(int j = -8; j <= 8; ++j) {
                    ...
                    if (block instanceof BlockOre) {
                        player.func_145747_a(new ChatComponentText("Optima Axe: §l§oI sense a " + block.func_149732_F() + "§l§o within atleast " + player.func_70011_f((double)j2, (double)k, (double)l) + " blocks of you."));
    ...
    public ItemStack func_77659_a(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        ...
        if (p_77659_3_.field_71071_by.func_146028_b(TitanItems.ultimaBlade)) {
            ...
            if (list != null && !list.isEmpty()) {
                for(int i1 = 0; i1 < list.size(); ++i1) {
                    ...
                    if (entity != null && entity.func_70089_S() && entity instanceof EntityLivingBase && !(entity instanceof EntityTitan) && entity != p_77659_3_) {
                        entity.func_82149_j(p_77659_3_);
    ...
    public boolean func_77644_a(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (target != null) {
            ...
            if (target instanceof EntityTitan && ((EntityTitan)target).canBeHurtByPlayer()) {
                ...
                ((EntityTitan)target).setTitanHealth(((EntityTitan)target).func_110143_aJ() - 3000.0F * (float)bonusdamage - extradamage);
    ...
    public void func_77663_a(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (entityIn instanceof EntityPlayer && !worldIn.field_72995_K) {
            if (stack.func_77960_j() == 0 && entityIn.field_70173_aa % 2 == 0) {
                ((EntityPlayer)entityIn).func_145747_a(new ChatComponentText("Optima Axe: You are unworthy of my power."));
                ((EntityPlayer)entityIn).field_71071_by.func_146026_a(TitanItems.optimaAxe);
                ...
                if (((EntityPlayer)entityIn).field_71071_by.func_146028_b(TitanItems.ultimaBlade)) {
                    WorldServer worldserver = MinecraftServer.func_71276_C().field_71305_c[0];
                    WorldInfo worldinfo = worldserver.func_72912_H();
                    worldinfo.func_76080_g(9999999);
                    worldinfo.func_76090_f(1000000);
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack) {
        ...
        if (!entityLiving.field_70170_p.field_72995_K && entityLiving instanceof EntityPlayer) {
            ...
            double dx = vec3.field_72450_a * (double)16.0F;
            double dy = (double)entityLiving.func_70047_e() + vec3.field_72448_b * (double)16.0F;
            double dz = vec3.field_72449_c * (double)16.0F;

            for(int k1 = -4; k1 <= 4; ++k1) {
                for(int l1 = -2; l1 <= 2; ++l1) {
                    for(int i2 = -4; i2 <= 4; ++i2) {
                        int y = MathHelper.func_76128_c(entityLiving.field_70163_u + dy + (double)l1);
                        int x = MathHelper.func_76128_c(entityLiving.field_70165_t + dx + (double)k1);
                        int z = MathHelper.func_76128_c(entityLiving.field_70161_v + dz + (double)i2);
        ...
        double dx = vec3.field_72450_a * (double)12.0F;
        double dy = (double)entityLiving.func_70047_e() + vec3.field_72448_b * (double)12.0F;
        double dz = vec3.field_72449_c * (double)12.0F;
        List list1 = entityLiving.field_70170_p.func_72839_b(entityLiving, entityLiving.field_70121_D.func_72314_b((double)12.0F, (double)8.0F, (double)12.0F).func_72317_d(dx, dy, dz));
        if (list1 != null && !list1.isEmpty()) {
            for(int i11 = 0; i11 < list1.size(); ++i11) {
                Entity entity1 = (Entity)list1.get(i11);
                    ...
                    if (entity1 != null) {
                        ...
                        if (entity1 instanceof EntityTitan) {
                            ...
                            if (!((EntityTitan)entity1).canBeHurtByPlayer() && entityLiving instanceof EntityPlayer) {
                                ((EntityPlayer)entityLiving).func_145747_a(new ChatComponentText(((EntityTitan)entity1).func_70005_c_() + ": Quit flailing that giant axe at me."));
                            }
