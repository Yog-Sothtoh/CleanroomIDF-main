...
public class WorldGenSpiderJockeyTitan extends WorldGenerator {
    ...
    public boolean func_76484_a(World worldIn, Random rng, int x, int y, int z) {
        if (!worldIn.func_147439_a(x, y - 1, z).func_149662_c()) {
            ...
            ++y;
        } else if (!worldIn.field_72995_K && worldIn.func_147437_c(x, y, z) && worldIn.func_147439_a(x, y - 1, z).func_149662_c() && rng.nextInt(1000) == 0) {
            EntitySkeletonTitan entityomegafish = new EntitySkeletonTitan(worldIn);
            entityomegafish.setSkeletonType(0);
            entityomegafish.func_70062_b(0, new ItemStack(Items.field_151031_f));
            ...
            entityomegafish1.destroyBlocksInAABBGriefingBypass(entityomegafish1.field_70121_D);
            entityomegafish1.func_82149_j(entityomegafish);
            entityomegafish1.func_110161_a((IEntityLivingData)null);
