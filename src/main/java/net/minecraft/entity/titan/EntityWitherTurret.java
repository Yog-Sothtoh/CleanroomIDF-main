...
public class EntityWitherTurret extends EntityGolem implements IRangedAttackMob {
    ...
    public void func_70636_d() {
        ...
        if (list11 != null && !list11.isEmpty() && this.func_70638_az() == null) {
            for(int i1 = 0; i1 < list11.size(); ++i1) {
                ...
                if (entity instanceof EntityLivingBase && entity != null && entity.func_70089_S() && this.func_70638_az() == null && this.canTargetEntity((EntityLivingBase)entity) && this.func_70685_l(entity) && entity.field_70163_u + (double)entity.func_70047_e() >= this.field_70163_u + (double)6.0F) {
        ...
        if (this.func_70638_az() != null && !this.field_70170_p.field_72995_K) {
            ...
            if (!this.func_70638_az().func_70089_S() || this.func_70638_az().field_70128_L || this.func_70638_az().field_70163_u + (double)this.func_70638_az().func_70047_e() < this.field_70163_u + (double)6.0F || this.func_70638_az().func_70068_e(this) > (double)10000.0F || !this.func_70685_l(this.func_70638_az())) {
    ...
    private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_) {
        if (this.shootingTimer <= 0) {
            this.func_85030_a("thetitans:turretShoot", 6.0F, 1.0F);
            ...
            EntityHomingWitherSkull entitywitherskull = new EntityHomingWitherSkull(this.field_70170_p, this, d6, d7, d8);
            if (p_82209_8_) {
                entitywitherskull.func_82343_e(true);
            }

            if (this.func_70638_az() != null) {
                entitywitherskull.assginedEntity = this.func_70638_az();
            }
    ...
    public boolean func_70097_a(DamageSource source, float amount) {
        if (this.func_85032_ar()) {
            ...
            if (source != DamageSource.field_82728_o && source != DamageSource.field_76377_j && source != DamageSource.field_76372_a && source != DamageSource.field_76371_c && source != DamageSourceExtra.lightningBolt && source != DamageSource.field_76370_b && source != DamageSource.field_76376_m && source != DamageSource.field_82727_n && source != DamageSource.field_82729_p && source != DamageSource.field_76369_e && source != DamageSource.field_76367_g) {
                ...
                if (entity instanceof EntityLivingBase && !this.func_85032_ar() && entity.field_70163_u + (double)entity.func_70047_e() >= this.field_70163_u + (double)8.0F) {
    ...
    protected void func_70609_aI() {
        ...
        this.field_70170_p.func_147449_b(i, j, k, Blocks.field_150357_h);
        if (!this.field_70170_p.field_72995_K) {
            this.func_85030_a("thetitans:turretDeath", 6.0F, 1.0F);
