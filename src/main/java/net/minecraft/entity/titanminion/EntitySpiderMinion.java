...
public class EntitySpiderMinion extends EntitySpider implements IRangedAttackMob, ITemplar {
    ...
    public String func_70005_c_() {
        switch (this.getMinionTypeInt()) {
            case 1:
                return StatCollector.func_74838_a("entity.SpiderPriest.name");
            case 2:
                return StatCollector.func_74838_a("entity.SpiderZealot.name");
            case 3:
                return StatCollector.func_74838_a("entity.SpiderBishop.name");
            case 4:
                return StatCollector.func_74838_a("entity.SpiderTemplar.name");
            default:
                return StatCollector.func_74838_a("entity.SpiderLoyalist.name");
        }
    }
    ...
    public void setMinionType(int miniontype) {
        ...
        if (miniontype == 1) {
            ...
            this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a((double)240.0F);
            this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a((double)15.0F);
            this.field_70178_ae = true;
            this.func_70606_j(240.0F);
    ...
    public void func_70636_d() {
        ...
        if (this.getMinionTypeInt() == 4) {
            ...
            if (this.master == null && this.func_110143_aJ() > 0.0F && !this.field_70170_p.field_72995_K && this.field_70170_p.field_73013_u != EnumDifficulty.PEACEFUL) {
                ...
                if (this.field_70146_Z.nextInt(230) == 0) {
                    EntitySpiderMinion entitychicken = new EntitySpiderMinion(this.field_70170_p);
                    entitychicken.func_70012_b(this.field_70165_t, this.field_70163_u, this.field_70161_v, this.field_70177_z, 0.0F);
                    entitychicken.func_110161_a((IEntityLivingData)null);
        ...
        if (this.getMinionTypeInt() == 1) {
            if (this.field_70173_aa % 40 == 0 && this.entityToHeal != null) {
                if (this.entityToHeal.func_110143_aJ() < this.entityToHeal.func_110138_aP()) {
                    this.func_71038_i();
                    this.func_70671_ap().func_75651_a(this.entityToHeal, 180.0F, (float)this.func_70646_bf());
    ...
    public void TransformEntity(Entity entity) {
        ...
        EntitySpiderTitan entitytitan = new EntitySpiderTitan(entity.field_70170_p);
                    ...
                    if (list11 != null && !list11.isEmpty()) {
                        for(int i1 = 0; i1 < list11.size(); ++i1) {
                            ...
                            if (entity instanceof EntitySpiderMinion && entity != null) {
                                ((EntitySpiderMinion)entity).func_70690_d(new PotionEffect(Potion.field_76441_p.field_76415_H, 200));
                                this.field_70170_p.func_72889_a((EntityPlayer)null, 1017, (int)entity.field_70165_t, (int)entity.field_70163_u, (int)entity.field_70161_v, 0);
                            }
                        }
                    }
    ...
    public boolean func_70097_a(DamageSource source, float amount) {
        if (!this.func_85032_ar() && (this.getMinionTypeInt() < 4 || source != DamageSourceExtra.radiation)) {
            if (!(source.func_76346_g() instanceof EntitySpiderMinion) && (!(source.func_76346_g() instanceof EntitySpiderTitan) || source.func_76346_g() instanceof EntityCaveSpiderTitan)) {
    ...
    public IEntityLivingData func_110161_a(IEntityLivingData p_110161_1_) {
        if (this.field_70170_p.field_73012_v.nextInt(100) == 0) {
            EntitySkeletonMinion entityskeleton = new EntitySkeletonMinion(this.field_70170_p);
        ...
        if (this.field_70146_Z.nextInt(this.field_70170_p.field_73013_u == EnumDifficulty.NORMAL ? 25 : (this.field_70170_p.field_73013_u == EnumDifficulty.HARD ? 2 : 500)) == 0) {
            switch (this.field_70146_Z.nextInt(10)) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    this.func_70690_d(new PotionEffect(Potion.field_76441_p.field_76415_H, Integer.MAX_VALUE, 0, true));
    ...
    public class EntityAIFindEntityNearestInjuredAlly extends EntityAIBase {
        ...
        public boolean func_75250_a() {
            if (!this.field_179434_b.func_70089_S()) {
                ...
                List list = this.field_179434_b.field_70170_p.func_72872_a(EntitySpiderMinion.class, this.field_179434_b.field_70121_D.func_72314_b(d0, d0, d0));
                if (list.isEmpty()) {
                    return false;
                } else {
                    for(int i = 0; i < list.size(); ++i) {
